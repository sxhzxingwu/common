...
public class VUICornerFrameLayout extends FrameLayout {
    ...
    public VUICornerFrameLayout(Context context) {
        super(context);
    }

    public VUICornerFrameLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

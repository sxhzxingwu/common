 ...
 */
package com.android.weici.common.widget.wheel.adapter;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	 ...
	 */
	AbstractWheelTextAdapter(Context context, int itemResource) {
		this(context, itemResource, NO_RESOURCE, 2);
	}
	...
	private LayoutParams getLayout(){
	    if(mTextLp == null)
        mTextLp = new LayoutParams(Tools.dip2px(context, 50), LayoutParams.WRAP_CONTENT);
        return mTextLp;
    }
}

package com.android.weici.common.widget.fancybutton;
...
public class FancyButton extends LinearLayout {
    ...
    private int    mDefaultTextSize    = Tools.dip2px(getContext(), 15);
    private int    mDefaultTextGravity = 0x11; // Gravity.CENTER
    private String mText               = null;

    // # Icon Attributes
    private Drawable mIconResource = null;
    private int      mFontIconSize = Tools.dip2px(getContext(), 15);

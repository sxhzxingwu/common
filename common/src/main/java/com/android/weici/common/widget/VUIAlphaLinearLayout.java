...
public class VUIAlphaLinearLayout extends LinearLayout {

    protected VUIAlphaViewHelper mAlphaViewHelper;

    public VUIAlphaLinearLayout(Context context) {
        super(context);
    }

    public VUIAlphaLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

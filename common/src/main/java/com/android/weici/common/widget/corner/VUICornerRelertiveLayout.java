...
public class VUICornerRelertiveLayout extends RelativeLayout {
    ...
    public VUICornerRelertiveLayout(Context context) {
        super(context);
    }

    public VUICornerRelertiveLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

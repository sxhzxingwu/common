 ...
 */
public class VUIPopup extends VUIBasePopup {
    ...
    public VUIPopup(Context context) {
        this(context, DIRECTION_NONE);
    }


    public VUIPopup(Context context, int preferredDirection) {
        super(context);
    ...
    private void setAnimationStyle(int screenWidth, int requestedX) {
        ...
        switch (mAnimStyle) {
            case ANIM_GROW_FROM_LEFT:
                mWindow.setAnimationStyle(onTop ? R.style.VUI_Animation_PopUpMenu_Left : R.style.VUI_Animation_PopDownMenu_Left);
                break;

            case ANIM_GROW_FROM_RIGHT:
                mWindow.setAnimationStyle(onTop ? R.style.VUI_Animation_PopUpMenu_Right : R.style.VUI_Animation_PopDownMenu_Right);
                break;

            case ANIM_GROW_FROM_CENTER:
                mWindow.setAnimationStyle(onTop ? R.style.VUI_Animation_PopUpMenu_Center : R.style.VUI_Animation_PopDownMenu_Center);
                break;
            case ANIM_AUTO:

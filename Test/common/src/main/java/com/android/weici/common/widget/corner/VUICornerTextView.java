...
public class VUICornerTextView extends AppCompatTextView {
    ...
    public VUICornerTextView(Context context) {
        super(context);
    }

    public VUICornerTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

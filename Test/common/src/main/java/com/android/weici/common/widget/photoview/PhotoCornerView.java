package com.android.weici.common.widget.photoview;
...
import com.android.weici.common.widget.corner.VUICornerImageView;
 ...
 */
public class PhotoCornerView extends VUICornerImageView {
    ...
    public PhotoCornerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PhotoCornerView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    private Runnable mClickRunnable = new Runnable() {
        ...
        public void run() {
            if (mClickListener != null) {
                mClickListener.onClick(PhotoCornerView.this);
            }
        }
    };
    ...
    private GestureDetector.OnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            if (mLongClick != null) {
                mLongClick.onLongClick(PhotoCornerView.this);
            }
        }

 ...
 * @date 2016-03-27
 */
public class VUIStatusBarHelper {
...
//                window.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        ...
        // 小米和魅族4.4 以上版本支持沉浸式
        if (VUIDeviceHelper.isMeizu() || VUIDeviceHelper.isMIUI()) {
            Window window = activity.getWindow();
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl(){
        return VUIDeviceHelper.isMIUIV5() || VUIDeviceHelper.isMIUIV6() ||
                VUIDeviceHelper.isMIUIV7() || VUIDeviceHelper.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(VUIDeviceHelper.isZUKZ1() || VUIDeviceHelper.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (VUIDeviceHelper.isTablet(context)
                && sStatusbarHeight > Tools.dip2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
            //状态栏高度大于25dp的平板，状态栏通常在下方
            sStatusbarHeight = 0;
        } else {
            if (sStatusbarHeight <= 0
                    || sStatusbarHeight > Tools.dip2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP * 2)) {
    ...
    public static void setWindowStatusBarColor(Activity activity, int colorResId) {
        try {
            ...
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT){
                setStatusBarTint(activity,colorResId);
            }
    ...
    public static boolean isTranslucent() {
        ...
        // 小米和魅族4.4 以上版本支持沉浸式
        return VUIDeviceHelper.isMeizu() || VUIDeviceHelper.isMIUI();

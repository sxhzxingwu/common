...
public class PieView extends View {
    ...
    private void drawA(Canvas canvas, float start, float length, String text, int color){
        ...
        float l = Tools.dip2px(getContext(), 17);//斜线的长度

        float line2W = Tools.dip2px(getContext(), 65);//文字底部线的长度
    ...
    private void drawItem(Canvas canvas, Item item){
        ...
        canvas.drawCircle(item.px, item.py, Tools.dip2px(getContext(),2), mTextPaint);
    ...
    private void init(){
        ...
        mTextHeight = Tools.dip2px(getContext(), 14);
        mPaint = new Paint();
        ...
        mTextPaint.setTextSize(Tools.dip2px(getContext(), 12));
        mTextPaint.setAntiAlias(true);
        mTextPaint.setStyle(Paint.Style.FILL);

        W = Tools.dip2px(getContext(), 25);
        radius = Tools.dip2px(getContext(), 40) + W/2f;
        textPadBottom = Tools.dip2px(getContext(), 3);//文字与线的距离
    }
